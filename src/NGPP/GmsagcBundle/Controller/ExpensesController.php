...
class ExpensesController extends Controller
{
    ...
    public function deleteAction($id)
    {
        ...
        if(!is_null($expense))
        {
            ...
            $this->get('session')->getFlashBag()->add('success', $this->get('translator')->trans('expenses.deleted'));
        }
        else
            $this->get('session')->getFlashBag()->add('error', $this->get('translator')->trans('expenses.nodeleted'));
